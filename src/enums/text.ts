export const TEXT = {
  EN: {
    ...
    EMBED_CODE_PLACEHOLDER: 'Paste JSFiddle or LikeButton link, and press enter',
  ...
  ZH_HANS: {
    ...
    EMBED_CODE_PLACEHOLDER: '贴上 JSFiddle、LikeButton 链接後，Enter 进行新增',
  ...
  ZH_HANT: {
    ...
    EMBED_CODE_PLACEHOLDER: '貼上 JSFiddle、LikeButton 連結後，Enter 進行新增',
