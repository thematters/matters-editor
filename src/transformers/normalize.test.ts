...
describe('Normalization: Comment', () => {
  ...
  test('link', () => {
    ...
    // normal link
    expectNormalizeCommentHTML(
      '<p><a target="_blank" rel="noopener noreferrer ugc nofollow" href="https://example.com">abc</a></p>',
      '<p><a target="_blank" rel="noopener noreferrer ugc nofollow" href="https://example.com">abc</a></p>',
    )

    // long link
    expectNormalizeCommentHTML(
      `<p><a target="_blank" rel="noopener noreferrer ugc nofollow" href="${longURL}">${longURL}</a></p>`,
      `<p><a target="_blank" rel="noopener noreferrer ugc nofollow" href="${longURL}">medium.com/yihan-hua...</a></p>`,
    ...
    expectNormalizeCommentHTML(
      `<p><a class="mention" data-id="id" data-display-name="${longDisplayName}" data-user-name="userName" rel="noopener noreferrer ugc nofollow" href="${longURL}">@${longDisplayName}</a></p>`,
      `<p><a class="mention" href="/@userName" data-id="id" data-user-name="userName" data-display-name="${longDisplayName}" rel="noopener noreferrer ugc nofollow"><span>@${longDisplayName}</span></a></p>`,
