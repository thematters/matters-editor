...
var FigureAudio = core.Node.create({
    ...
    addProseMirrorPlugins: function () {
        return [
            new state.Plugin({
                key: new state.PluginKey('removePastedFigureAudio'),
                props: {
...
var FigureEmbed = core.Node.create({
    ...
    addProseMirrorPlugins: function () {
        return [
            new state.Plugin({
                key: new state.PluginKey('removePastedFigureEmbed'),
                props: {
                    transformPastedHTML: function (html) {
                        // remove
...
var FigureImage = core.Node.create({
    ...
    addProseMirrorPlugins: function () {
        return [
            new state.Plugin({
                key: new state.PluginKey('removePastedFigureImage'),
                props: {
                    transformPastedHTML: function (html) {
                        // remove
...
var MentionPluginKey = new state.PluginKey('mention');
